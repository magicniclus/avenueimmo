...
const ContainerEstimation = (props) => {
  ...
  return (
    <div
      id="estimation"
      className="lg:w-full sm:w-11/12 w-full max-w-[1250px] min-h-[450px] px-5 py-10 lg:px-20 lg:py-16 flex items-center justify-between flex-col lg:flex-row relative z-20 bg-slate-50 md:mt-10 rounded-lg"
    >
